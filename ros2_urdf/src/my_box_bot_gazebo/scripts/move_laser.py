...
# ros2 action list -t# ros2 action info /joint_trajectory_controller/follow_joint_trajectory -t# ros2 interface show control_msgs/action/FollowJointTrajectory
...
class SteeringActionClient(Node):
    ...
    def goal_response_callback(self, future):
        ...
        if not goal_handle.accepted:
            ...
            return self.get_logger().info('Goal accepted :)')
